"""Experiment 0 modeling workflow for ERCOT DART prediction.

This workflow performs machine learning modeling experiments on the finalized
exp0 study datasets. It processes each settlement point (location/location_type)
independently and trains models for DART price prediction.

Key features:
- Loads finalized datasets using DartSltExp0Dataset
...
from src.models.ercot.exp0 import DartSltExp0Dataset
from src.models.ercot.exp0.model_trainer import Exp0ModelTrainer
...
def main():
    ...
    """
    script_name = "04-kag-exp0-ercot-modeling"
