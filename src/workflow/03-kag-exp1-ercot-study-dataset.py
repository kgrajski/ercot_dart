"""Script for creating the study dataset for experiment 1."""
...
from src.features.ercot.exp1 import Exp1Dataset


def main():
    """Main function for preparing the experiment 1 study dataset."""

    script_name = "03-kag-exp1-ercot-study-dataset"
    ...
    output_dir = os.path.join(project_dir, "data/studies/exp1", processed_data_date)
    os.makedirs(output_dir, exist_ok=True)

    print("\nInitializing Exp1Dataset handler...")
    exp1 = Exp1Dataset(input_dir=input_dir, output_dir=output_dir)

    print("\nLoading and validating input data...")
    exp1.load_data()

    print("\nGenerating dependent variables...")
    exp1.generate_dependent_vars()
