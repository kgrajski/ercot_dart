...
- The figure above shows a dashboard when train on 2024 and validate on 2025 (to June 4, 2025).

---

![DART Price Prediction Zoomed](reports/figures/initial_dart_houston/exp1_xgboost_dashboard_zoom.png)

- The figure above shows a zoomed dashboard when train on 2024 and validate on 2025 (to June 4, 2025).
...
### DART Price Sign (Pos vs Neg) Forecasting as a Trading Signal (Exp2 Data; Exp0 Model)
